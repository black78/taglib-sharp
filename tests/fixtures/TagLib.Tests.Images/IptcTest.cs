...
namespace TagLib.Tests.Images
{
	...
	public class IptcIimTest
	{
		...
		{
			var file = TagLib.IO.File.Create("samples/sample_iptc1.jpg");
		...
		{
			var file = TagLib.IO.File.Create("samples/sample_iptc2.jpg");
			var tag = file.GetTag (TagTypes.XMP) as XmpTag;
		...
		{
			var file = TagLib.IO.File.Create("samples/sample_iptc3.jpg");
			var tag = file.GetTag (TagTypes.XMP) as XmpTag;
